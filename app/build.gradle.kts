...
sonar {
    properties {
        ...
        property("sonar.organization", "se2-alpha1")
        ...
        property("sonar.coverage.exclusions", "**/MainActivity.kt,**/StartMenuActivity.kt,**/LobbyActivity.kt,**/GameActivity.kt,**/ui/theme/**")
    }
}
