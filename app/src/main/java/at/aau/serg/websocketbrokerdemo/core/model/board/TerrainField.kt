...
class TerrainField(var type: TerrainType, val id: Int) { //needs quadrant number and ids of neighbours
    ...
    fun getNeighbours(id: Int): Array<Int>{
        if (id > -1 && id < 400) {
            when (id) {
                20, 60, 100, 140, 180, 220, 260, 300, 340 -> return arrayOf(
                    id - 20,
                    id - 19,
                    id + 1,
                    id + 20,
                ...
                40, 80, 120, 160, 200, 240, 280, 320, 360 -> return arrayOf(
                    id - 20,
                    id + 1,
                    id + 20
                )

                39, 79, 119, 159, 199, 239, 279, 319, 359 -> return arrayOf(
                    id - 20,
                    id - 1,
                    id + 20
                )

                59, 99, 139, 179, 219, 259, 299, 339, 379 -> return arrayOf(
                    id - 21,
                    id - 20,
                    id - 1,
                    id + 19,
                ...
                in 21..38, in 61..78, in 101..118, in 141..158, in 181..198, in 221..238, in 261..278, in 301..318, in 341..378 -> return arrayOf(
                    id - 20,
                    id - 19,
                    id - 1,
                    id + 1,
                    ...
                    return arrayOf(id - 21, id - 20, id - 1, id + 1, id + 19, id + 20)
                }
            }
        }
        return arrayOf(-1)
